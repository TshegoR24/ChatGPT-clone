...
let userText = null;
const API_KEY = "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";
...
const getChatResponse = async (incomingChatDiv) => {
    ...
    // Define the properties and date for the API request
    const requestOption = {
        method:"POST",
        headers: {
...
themeButton.addEventListener("click", () => {
    // Toggle body's class for the theme mode save the updated theme to the local storage
